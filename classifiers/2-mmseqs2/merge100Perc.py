...
with open('100perc_all_results.tsv', 'w') as out:
    ...
    for l in glob('*100perc_lca.tsv'):
        ...
        database = database.replace('_index_out_100perc_lca.tsv', '')
        with open(l) as fh:
            for line in fh:
                ...
                try:
                    ...
                    position = 100
                newll = ['MMSeqs2_100', query, database, 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', asv]#, taxlevel, taxid]
                if position != 100:
